...
enum SirenUtils {
  ...
  private static final String TAG = "SirenUtils";
   ...
   */
  public File getImageCacheDir(Context context, String cacheName) {
    File cacheDir = context.getExternalCacheDir();
    if (cacheDir != null) {
      File result = new File(cacheDir, cacheName);
      if (isFileNotExists(result)) {
  ...
  public boolean isFileNotExists(File file) {
